@UI_US_13
Feature: Vice Dean should be able to create teachers.

  Scenario: TC_01 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
  ...
  Scenario: TC_02 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_03 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_04 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_05 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_06 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_07 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_08 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_09 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
    ...
    And Phone in the box "a phone number" enters_hu
    And Is Advisor Teacher_hu
    And Gender "FEMALE" enters your option_hu
    And Gender "MALE" enters your option_hu
    And Gender "FEMALE" enters your option_hu
    And DateOfBirth in the box "01/01/1983" enters_hu
    And SSN in the box "an ssn number" enters_hu
  ...
  Scenario: TC_10 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_11 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_12 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_13 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_14 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
    ...
    And SSN in the box "an ssn number" enters_hu
    And UserName new "a username" enters the box_hu
    And Enter the password "Karamn1" in the password box_hu
    Then Password It is confirmed that it gives a warning when it is less than 8 characters._hu
    Then Close page_hu

  Scenario: TC_15 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_16 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
    ...
    And UserName new "a username" enters the box_hu
    And Enter the password "karaman1" in the password box_hu
    Then Password it is confirmed that it gives a warning when it does not contain capital letters_hu
    Then Close page_hu

  Scenario: TC_17 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
  ...
  Scenario: TC_18 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
    ...
    And SSN in the box "an ssn number" enters_hu
    And UserName new "a username" enters the box_hu
    And Enter the password "Karamanlı" in the password box_hu
    Then Passworden it is confirmed that it gives a warning when it does not contain at least one digit_hu
    Then Close page_hu

  Scenario: TC_19 Vice Dean should be able to create teachers.
    Given User enters the website_hu
    When User clicks on login_hu
    And Username in the box "Team05ViceDean" enters_hu
    And Password in the box "Project14" enters_hu
