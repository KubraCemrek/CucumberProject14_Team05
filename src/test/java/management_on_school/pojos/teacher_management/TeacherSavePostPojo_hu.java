...
public class TeacherSavePostPojo_hu implements Serializable {
	...
	public TeacherSavePostPojo_hu() {
	}

	public TeacherSavePostPojo_hu(String birthDay, String birthPlace, String email, String gender, boolean isAdvisorTeacher, List<Integer> lessonsIdList, String name, String password, String phoneNumber, String ssn, String surname, String username) {
