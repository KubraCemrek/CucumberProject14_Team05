...
import management_on_school.pages.C01_AddDeanPage_GürkayHoca;
...
public class ORNEK_Dean_StepDef_UI {

    ResultSet resultSet;
    C01_AddDeanPage_GürkayHoca addDean = new C01_AddDeanPage_GürkayHoca();
    ...
    public void kullanici_login_e_tiklar() {
        addDean = new C01_AddDeanPage_GürkayHoca();
